...
class GiorgioArmaniMyWay : Fragment() {
    ...
    override fun onCreateView(
        ...
        goBack.setOnClickListener(){
            ...
            navController.navigate(R.id.action_giorgioArmaniMyWay_to_exploreFragment)
        }
        ...
        bottomNavigationView.setOnItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.navigation_home -> {
                    // Handle home click
                    Navigation.findNavController(view).navigate(R.id.action_giorgioArmaniMyWay_to_cartFragment)
                    true
                }
                R.id.navigation_search -> {
                    ...
                    Navigation.findNavController(view)
                        .navigate(R.id.action_giorgioArmaniMyWay_to_exploreFragment)
                ...
                R.id.navigation_cart -> {
                    // Handle cart click
                    Navigation.findNavController(view)
                        .navigate(R.id.action_giorgioArmaniMyWay_to_cartFragment)
                    true
                }
                R.id.navigation_user -> {
                    // Handle user click
                    Navigation.findNavController(view)
                        .navigate(R.id.action_giorgioArmaniMyWay_to_userFragment)
                    true
                }
                else -> false
            }
